...
public class Application {
    ...
    static public final String AUTHOR = "Kostromin Artem";
    ...
    public static void main(String[] args) {
        ...
        //================================Console View======================================
        /*ConsoleCanvas canvas = new ConsoleCanvas(40,40);
        canvas.init();
        canvas.draw();
        canvas.drawSquareAt(1,1,3);*/


        //=================================DataBase=========================================

        // We can't to write try-catch with Throws exception.

        List<String[]> records = DataBase.readDataFile("D:/Training/Criminals.txt") ;
        ...
        //System.out.println(table.selectField("deceased"));

        /*Record record = new Record(table);
        record.setValues(table);
        record.setValues(new String[]{"100", "Anthony", "false"});
        try {
